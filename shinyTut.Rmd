...
Within TfL I mostly use it to build dashboards for interrogating and displaying data. 
...
```{r, eval=FALSE}
l = readLines("https://api.tfl.gov.uk/AccidentStats/2015?app_id=0f1de667&app_key=6c47ac149cfec9ccb6bf32b953a85dd3", encoding="UTF-8", warn=FALSE)
